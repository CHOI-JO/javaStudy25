...
public class ManagementExam {
	...
	public static void main(String[] args) {
		...
		while(run) {
			...
			case 1 : // Create Read Update Delete 기법에 맞추기
				boolean subRun = true;
				
				String employee1 = "김민수";
				String employee2 = "박지환";

				
				while (subRun) {
					System.out.println("===============교직원 관리=============");
					System.out.println("1. 교직원 등록"); // C
					System.out.println("2. 교직원 보기"); // R
					System.out.println("3. 교직원 수정"); // U
					System.out.println("4. 교직원 삭제"); // D
					System.out.println("5. 교직원 관리 메뉴 종료");
					...
					case 2 :
						...
						case 1 :
							...
							System.out.println("===================================");
							System.out.println("이름: " + employee1);
						...
						case 2 :
							...
							System.out.println("선택한 교직원 번호는 " + employeeNumber + " 입니다.");
							System.out.println("===================================");
							System.out.println("이름: " + employee2);
					...
					case 4 :
						...
						case 1 :
							System.out.println("\n" + "===================================");
							System.out.println(employee1 + " 님의 데이터가 삭제되었습니다.");
							break;
							
						case 2 :
							System.out.println("\n" + "===================================");
							System.out.println(employee2 + " 님의 데이터가 삭제되었습니다.");
							break;
					...
					case 5 :
						System.out.println("===========교직원 관리 메뉴 종료========");
						subRun = false;
						break;
						
					default :
						System.out.println("======================================");
						System.out.println("1~5중의 숫자로 다시 입력해주세요." + "\n");
						break;	
			...
			case 2 :
				...
				while (subRun2) {
					...
					System.out.println("5. 학생 관리 메뉴 종료");
					System.out.print("(1~5) >>>>> ");
					int subSelect = inputInt.nextInt();
					...
					case 4 :
						...
						case 1 :
							System.out.println("\n" + "===================================");
							System.out.println("김철수님의 데이터가 삭제되었습니다.");
							break;
							
						case 2 :
							System.out.println("\n" + "===================================");
							System.out.println("김영희님의 데이터가 삭제되었습니다.");
							break;
							
						case 3 :
							System.out.println("\n" + "===================================");
							System.out.println("박재현님의 데이터가 삭제되었습니다.");
							break;
							
						case 4 :
							System.out.println("\n" + "===================================");
							System.out.println("김수진님의 데이터가 삭제되었습니다.");
							break;
							
						case 5 :
							System.out.println("\n" + "===================================");
							System.out.println("이은지님의 데이터가 삭제되었습니다.");
							break;
						} // 선택한 학생 데이터 삭제
						break; // 학생 삭제 switch 종료
						
					case 5 :
						System.out.println("===========학생 관리 메뉴 종료========");
						subRun2 = false;
						break;
			...
			case 3 :
				...
				while (subRun3) {
					...
					System.out.println("5. 성적 관리 메뉴 종료");
					System.out.print("(1~5) >>>>> ");
					int subSelect = inputInt.nextInt();
					...
					case 5 :
						System.out.println("===========성적 관리 메뉴 종료========");
						subRun3 = false;
						break;
			...
			default : // 위 조건에 해당하지 않는 값
				System.out.println("======================================");
				System.out.println("1~4중의 숫자로 다시 입력해주세요." + "\n");
				break;
			} //switch문 종료
