...
public class ArrayLoginExam {
	...
	public static void main(String[] args) {
		...
		static void Score() {
			...
			String [] student = new String[] {"김철수", "김영희", "박재현", "이은지"};
			double [] math = new double[] {93, 85, 87, 60, 30};
			double [] korean = new double[] {96, 36, 98, 79, 66};
			double [] english = new double[] {100, 99, 98, 48, 76};
			double [] history = new double[] {94, 82, 100, 72, 69};
			double [] science = new double[] {66, 100, 81, 70, 93};

			int sum = add(student, math, korean, english, history, science);
			double [] average = null;
			
			for(int i = 0; i < student.length; i++) {
				average[i] = (math[i] + korean[i] + english[i] + history[i] + science[i]) / 5;
			}
			...
			case 2 :
				...
				while (run3) {
					System.out.println("\n 확인할 학생의 번호를 입력하세요.");
					System.out.println("1. " + student[0]);
					System.out.println("2. " + student[1]);
					System.out.println("3. " + student[2]);
					System.out.println("4. " + student[3]);
					System.out.println("5. " + student[4]);
					studentNumber = inputInt.nextInt();
					
					for(int i=0; i<student.length; i++) {
						if(i==studentNumber) {
							System.out.println("\n" + "===================================");
							System.out.println("선택한 학생은 " + student[i] + " 입니다.");
							System.out.println("===================================");
							System.out.println("이름: " + student[i]);
							System.out.println("전체 평균: " + average[i]);
		...
		private static int add(String[] student, double[] math, double[] korean, double[] english, double[] history,
				double[] science) {
